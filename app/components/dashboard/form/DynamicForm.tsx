                ...
                <div className="space-y-4">
                  <div className="flex flex-col gap-2">
                    <label 
                      ...
                      className="cursor-pointer inline-flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black transition-colors"
                    >
                      <svg 
                    ...
                    <span className="text-xs text-gray-500">
                      Accepted formats: JPG, PNG, WEBP (Max 7MB)
                    </span>
                  </div>
                  {preview && (
